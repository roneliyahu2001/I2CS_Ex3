 ...
 * 4. Your are asked to implement the following classes: assignments.Ex3.Index2D, assignments.Ex3.Map, assignments.Ex3.Ex3Algo.
...
public class Ex3Main {
    ...
    public static void play1() {
        ...
        while(ex3.getStatus()!=PacmanGame.DONE) {
            ...
            if (_cmd != null && _cmd == 'h') {
            	System.out.println("Pacman help: keys: ' '-start, 'w,a,x,d'-directions, all other parameters should be configured via assignments.Ex3.GameInfo.java, ");
            }
